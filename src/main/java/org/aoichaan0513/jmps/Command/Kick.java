                    ...
                    if (args.length != 1) {
                        ...
                        if (CoreAPI.isOnlinePlayer(args[0])) {
                            ...
                            if (CoreAPI.isPlayed(p)) {
                                String json = "{\"apiKey\": \"" + Main.getInstance().getConfig().getString("apiKey") + "\", \"name\": \"" + p.getName() + "\", \"uuid\": \"" + p.getUniqueId().toString() + "\", \"reason\": \"" + str.trim() + "\", \"byName\": \"" + sender.getName() + "\", \"byUUID\": \"" + ((Player) sender).getUniqueId().toString() + "\", \"server\": \"" + new Server().getId() + "\"}";
                                ...
                                try {
                                    ...
                                    if (jsonObject.getBoolean("result")) {
                                        ...
                                        sender.sendMessage(CoreAPI.getSuccessPrefix() + p.getName() + "をキックしました。\n" +
                                                CoreAPI.getInfoPrefix() + "処罰理由: " + str.trim());
                                        return true;
                                    } else {
                                        sender.sendMessage(CoreAPI.getErrorPrefix() + p.getName() + "をキックできませんでした。\n" +
                        ...
                        sender.sendMessage(CoreAPI.getErrorPrefix() + op.getName() + "はオフラインです。");
                        return true;
                    } else {
                        String str = "Kicked by operator.";
                        if (CoreAPI.isOnlinePlayer(args[0])) {
                            Player p = Bukkit.getPlayerExact(args[0]);
                            if (CoreAPI.isPlayed(p)) {
                                String json = "{\"apiKey\": \"" + Main.getInstance().getConfig().getString("apiKey") + "\", \"name\": \"" + p.getName() + "\", \"uuid\": \"" + p.getUniqueId().toString() + "\", \"reason\": \"" + str.trim() + "\", \"byName\": \"" + sender.getName() + "\", \"byUUID\": \"" + ((Player) sender).getUniqueId().toString() + "\", \"server\": \"" + new Server().getId() + "\"}";
            ...
            if (args.length != 0) {
                if (args.length != 1) {
                    ...
                    if (CoreAPI.isOnlinePlayer(args[0])) {
                        Player p = Bukkit.getPlayerExact(args[0]);
                        if (CoreAPI.isPlayed(p)) {
                            String json = "{\"apiKey\": \"" + Main.getInstance().getConfig().getString("apiKey") + "\", \"name\": \"" + p.getName() + "\", \"uuid\": \"" + p.getUniqueId().toString() + "\", \"reason\": \"" + str.trim() + "\", \"byName\": \"" + sender.getName() + "\", \"byUUID\": \"f78a4d8d-d51b-4b39-98a3-230f2de0c670\", \"server\": \"" + new Server().getId() + "\"}";
                            String result = CoreAPI.sendPost("Kick.php", json);
