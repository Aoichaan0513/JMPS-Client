                    ...
                    if (args.length != 1) {
                        ...
                        if (CoreAPI.isOnlinePlayer(args[0])) {
                            ...
                            if (CoreAPI.isPlayed(p)) {
                                if (!CoreAPI.isPunished(p, CoreAPI.PunishType.WARNING)) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObject.getBoolean("result")) {
                                            ...
                                            sender.sendMessage(CoreAPI.getSuccessPrefix() + p.getName() + "を警告しました。\n" +
                                                    CoreAPI.getInfoPrefix() + "処罰理由: " + str.trim());
                                            return true;
                                        } else {
                                            sender.sendMessage(CoreAPI.getErrorPrefix() + p.getName() + "を警告できませんでした。\n" +
                                ...
                                sender.sendMessage(CoreAPI.getErrorPrefix() + p.getName() + "はすでにこのサーバーで警告されています。");
                                return true;
                            }
                            ...
                            if (CoreAPI.isPlayed(op)) {
                                if (!CoreAPI.isPunished(op, CoreAPI.PunishType.WARNING)) {
                                    ...
                                    try {
                                        JSONObject jsonObject = new JSONObject(result);
                                        if (jsonObject.getBoolean("result")) {
                                            sender.sendMessage(CoreAPI.getSuccessPrefix() + op.getName() + "を警告しました。\n" +
                                                    CoreAPI.getInfoPrefix() + "処罰理由: " + str.trim());
                                            return true;
                                        } else {
                                            sender.sendMessage(CoreAPI.getErrorPrefix() + op.getName() + "を警告できませんでした。\n" +
                                                    CoreAPI.getInfoPrefix() + "理由: " + jsonObject.getString("reason"));
                                            return true;
                                        }
                                    } catch (Exception e) {
                                ...
                                sender.sendMessage(CoreAPI.getErrorPrefix() + op.getName() + "はすでにこのサーバーで警告されています。");
                                return true;
                            }
                        ...
                        String str = "Warning by operator.";
                        if (CoreAPI.isOnlinePlayer(args[0])) {
                            Player p = Bukkit.getPlayerExact(args[0]);
                            if (CoreAPI.isPlayed(p)) {
                                if (!CoreAPI.isPunished(p, CoreAPI.PunishType.WARNING)) {
